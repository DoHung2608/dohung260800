  ...
  <div class="container-fluid">
    <div class="panel-body">
      <a>
        ...
        if (isset($_POST['success'])) {
          ...
          echo "<h1 style='color:#0C0'>Thêm Sản Phẩm Thành Công &nbsp;&nbsp;  <span class='glyphicon glyphicon-ok'></h1></span>";
        }
        ?></a>
    </div>
    <div class="col-md-14">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card ">
          <div class="card-header card-header-primary">
            <h4 class="card-title"> Loại Sản Phẩm</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive ps">
              <table class="table table-hover tablesorter " id="">
      ...
      <div class="col-md-6">
        <div class="card ">
          <div class="card-header card-header-primary">
            <h4 class="card-title">Danh Sách Thương Hiệu</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive ps">
              <table class="table table-hover tablesorter " id="">
    ...
    <div class="col-md-5">
      <div class="card ">
        <div class="card-header card-header-primary">
          <h4 class="card-title">Danh Sách Đăng Ký Page</h4>
        </div>
        <div class="card-body">
          <div class="table-responsive ps">
            <table class="table table-hover tablesorter " id="">
