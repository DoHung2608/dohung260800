...
<head>
	...
	<style>
		#navigation {
			...
			background: -webkit-linear-gradient(to right, #F9D423, #D0F5A9);
			/* Chrome 10-25, Safari 5.1-6 */
			background: linear-gradient(to right, #F9D423, #D0F5A9);
		...
		#header {
			...
			background: #40FF00;
			/* fallback for old browsers */
			background: -webkit-linear-gradient(to right, #061161, #40FF00);
			/* Chrome 10-25, Safari 5.1-6 */
			background: linear-gradient(to right, #061161, #40FF00);
			/* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
		...
		#top-header {
			...
			background: #2ECCFA;
			/* fallback for old browsers */
			background: -webkit-linear-gradient(to right, #348AC7, #2ECCFA);
			/* Chrome 10-25, Safari 5.1-6 */
			background: linear-gradient(to right, #348AC7, #2ECCFA);
			/* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
						...
						<div class="header-search">
							<form action="search.php" method="$_GET">
								<select class="input-select">
									...
									<option value="1">Đàn Ông</option>
									<option value="1">Phụ Nữ</option>
								</select>
								<input class="input" id="search" type="text" name="search" placeholder="Tìm kiếm ở đây">
								<button type="submit" id="search_btn" name="ok" class="search-btn">Tìm Kiếm</button>
							</form>
						</div>
