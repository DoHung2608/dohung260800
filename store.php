 		...
 		<div class="container">
 			...
 			<div class="row">
 				...
 				<div id="aside" class="col-md-3">
 					...
 					<!-- aside Widget -->
 					<div class="aside">
 						<h3 class="aside-title">Sản phẩm đang giảm giá</h3>
 				...
 				<div id="store" class="col-md-9">
 						...
 						<div class="store-sort">
 							<label>
 								...
 								<select class="input-select">
 									...
 									<option value="3">Đặc biệt</option>
 									<option value="4">Bán chạy nhất</option>
 								</select>
 							</label>
 					...
 					<!-- store bottom filter -->
 					<div class="store-filter clearfix">
 						<span class="store-qty">hiển thị 20-100 sản phẩm</span>
