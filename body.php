			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-6">
					<a href="product.php?p=12">
						<div class="shop">
							<div class="shop-img">
								<img src="./img/shop04.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Thời Trang<br></h3>
								<a href="store.php" class="cta-btn">Mua ngay <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</a>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="hot-deal">
						...
						<h2 class="text-uppercase">Ưu đãi trong tuần này</h2>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-xs-6">
					<div class="section-title">
						<h4 class="title">Sản phẩm giảm giá</h4>
						<div class="section-nav">
						...
						<div id="get_product_home2">
							...
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h3 class="product-name"><a href="#">Xem thêm</a></h3>
									<h4 class="product-price">980.00VNĐ<del class="product-old-price">990.00VNĐ</del></h4>
								</div>
							</div>
							<!-- /product widget -->
