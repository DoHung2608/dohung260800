...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($username)) { array_push($errors, "Username trống"); }
  if (empty($email)) { array_push($errors, "Email trống"); }
  if (empty($password_1)) { array_push($errors, "Password trống"); }
  ...
  if (count($errors) == 0) {
  	...
  	$_SESSION['success'] = "Bây giờ bạn có thể đăng nhập";
...
if (isset($_POST['login_user'])) {
  ...
  if (empty($password)) {
  	array_push($errors, "Password trống");
  }
