	...
	<div class="container-fluid">
		<div class="row-checkout">
			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="fname"><i class="fa fa-user" ></i> Họ Tên</label>
						...
						<label for="adr"><i class="fa fa-address-card-o"></i> Địa Chỉ</label>
						...
						<div class="col-50">
							...
							<input type="text" id="zip" name="zip" class="form-control" pattern="^[0-9]+$" required>
						</div>
						</div>
					</div>
					...
					<div class="col-50">
						<h3>Thanh Toán</h3>
						<label for="fname">Thẻ được chấp nhận</label>
						...
						<label for="cname"> Tên Chủ thẻ</label>
						...
						<label for="expdate"> Ngày Cấp</label>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Địa chỉ giao hàng như thanh toán
					</label>';
				$i = 1;
				$total = 0;
				...
				<input type="hidden" name="total_count" value="' . $total_count . '">
					...
					<input type="submit" id="submit" value="Thanh Toán" class="checkout-btn">
				</form>
				</div>
			</div>
			';
			...
			<div class="col-25">
				...
				<h3>total<span class='price' style='color:black'><b>$total VNĐ</b></span></h3>";
					}
					?>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="newsletter">
					<p>Đăng ký<strong> ƯU ĐÃI</strong></p>
					<form>
						<input class="input" type="email" placeholder="Nhập Email của bạn">
						<button class="newsletter-btn"><i class="fa fa-envelope"></i> Đăng ký</button>
					</form>
